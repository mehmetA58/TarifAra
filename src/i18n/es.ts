export const messages = {
  ...
  pantry: {
    ...
    inputPlaceholder: 'Introduce el código de barras…',
    search: 'Buscar',
    addToPantry: 'Añadir a la despensa',
    added: 'Añadido a la despensa',
    notFound: 'Producto no encontrado.',
    cameraError: 'Cámara no disponible — introduce el código manualmente.',
    emptyPantry: 'Tu despensa está vacía.',
    nutriScore: 'Nutri-Score',
    novaGroup: 'Grupo NOVA',
    per100g: 'por 100g',
    nutrients: {
      energy: 'Energía (kcal)',
      fat: 'Grasa',
